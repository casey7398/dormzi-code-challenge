            ...
            {!loading ? (
                <>
                    ...
                    <div className="pokemon-detail-container">
                        <Link to={linkPrev}>
                            <div className="prev-next-button"><ArrowBackIcon style={{ marginRight: 5 }} /> Previous</div>
                        </Link>
                        <div>
                            <span className="hint"> hint!</span> <span style={{ color: '#b57614', fontSize: 14 }}>use arrow keys to navigate</span>
                            <h2>Details for <span className="pokemon-name">{pokemonDetail.name}</span></h2>
                            <img src={pokemonDetail.picture} style={{ maxWidth: 200 }} alt={pokemonDetail.name} />
                            <br />
                            ...
                            <h2>Skills:</h2>
                            {Object.entries(pokemonDetail.skills)
                                .map(([key, values]) => {
                                    return (
                                        <>
                                            <h3>{key}</h3>
                        ...
                        <Link to={linkNext}>
                            <div className="prev-next-button">Next <ArrowForwardIcon style={{ marginLeft: 5 }} /></div>
                        </Link>
                    </div>
                </>
            ) : (
